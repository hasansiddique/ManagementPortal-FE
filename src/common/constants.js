...
export const AWS_DELETE_POLLING_TIMEOUT_INTERVAL =
  "%AWS_DELETE_POLLING_TIMEOUT_INTERVAL%"; // 20 minutes in ms
...
export const RESOURCE_POLLING_TIMEOUT_INTERVAL =
  "%RESOURCE_POLLING_TIMEOUT_INTERVAL%"; // 3 minutes in ms
