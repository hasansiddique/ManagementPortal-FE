...
const CRUDEmployee = ({
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'img',
      width: '50px',
      render: (record) => <img alt="test" src={`http://localhost:8000/${record}`} height={60} width={70} />,
    },
    {
      title: 'Name',
      dataIndex: 'Name',
    ...
    <Content style={{ margin: '0 16px' }}>
      ...
      >
        <Row>
              ...
              >
                <Row>
                  ...
                  <Col span={14}>
                    ...
                    >
                      {imgPreview ? <img src={imgPreview} alt="avatar" style={{ width: '100%' }} /> : uploadButton}
                    </Upload>
                  </Col>
                </Row>
              ...
              {!singleEmployeeState
                ...
                : (
                  <div>
                    ...
                    <Text>{singleEmployeeState && singleEmployeeState.employee.name}</Text>
                    <br />
                    <Text strong>Age: </Text>
                    <Text>{singleEmployeeState && singleEmployeeState.employee.age}</Text>
                    <br />
                    <Text strong>Gender: </Text>
                    <Text>{singleEmployeeState && singleEmployeeState.employee.gender}</Text>
                    <br />
                    <Text strong>Email: </Text>
                    <Text>{singleEmployeeState && singleEmployeeState.employee.email}</Text>
                    <br />
                    <Text strong>JoinDate: </Text>
                    <Text>{singleEmployeeState && singleEmployeeState.employee.joinDate.split('T')[0]}</Text>
                    <br />
                    <Text strong>Department: </Text>
                    <Text>{singleEmployeeState && singleEmployeeState.employee.department}</Text>
                    <br />
                    <Text strong>Designation: </Text>
                    <Text>{singleEmployeeState && singleEmployeeState.employee.designation}</Text>
                    <br />
                    <Text strong>Address: </Text>
                    <Text>{singleEmployeeState && singleEmployeeState.employee.address}</Text>
                  </div>
                )}
            </Modal>
          </Col>
          ...
          <Col span={6}>
            <Form.Item>
              <Input placeholder="filter by name" onChange={handleSearch} onClick={handleClick} />
            </Form.Item>
          </Col>
        </Row>
        {loading ? (
