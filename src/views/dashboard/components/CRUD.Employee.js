   ...
   // @Todo (Hanzlah)  working on image url to be served as static file
    ...
    const handleChange = ({fileList}) => {
        ...
        if (!isJpgOrPng) {
            ...
            getBase64(file[0].originFileObj, imageUrl =>
    ...
    const uploadButton = (
        <div className="ant-upload-text"><PlusOutlined />Image</div>
    );
                ...
                <Col span={10}>
                    <div>
                        ...
                        <Modal
                            ...
                            visible={visible ? visible : visibleUpdate ? visibleUpdate : null }
                            onOk={visible ? handleOkForRegistration : handleOkForUpdate ? handleOkForUpdate : null}
